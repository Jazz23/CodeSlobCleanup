...
3. If the agent does anything besides what it is instructed to do based on the skill, include what it did wrong and why it was wrong.
4. If the agent did anything redudant, include what it did that was unnecessary and why.
